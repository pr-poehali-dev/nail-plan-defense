    ...
    <div className="slide-wrap s0-layout">
      <div>
        ...
        <p style={{ fontSize: 15, color: "var(--muted)", lineHeight: 1.7, maxWidth: 440 }}>
          Проект предполагает организацию деятельности в сфере оказания услуг маникюра и художественного оформления ногтей. Основное внимание уделяется созданию эстетичного и ухоженного внешнего вида рук клиентов с применением современных безопасных материалов и методик.
        </p>
